...
public class Autonomous {
    ...
    public static Double bigSpeed = 0.0;
    public static void shootAuto(Boolean transport){ // this function automatically shoots
        ...
        if (ready && transport){
            Transport.setSpindexer(Transport.powerArray[Driver_Controller.kitchenStove()]/4.25);
            Transport.setTransport(Transport.powerArray[Driver_Controller.kitchenStove()]/1.5);
    ...
    public static final Double speed = 4.0, endVeloMult = 0.3*speed, shootTimeSec = 5.0;
